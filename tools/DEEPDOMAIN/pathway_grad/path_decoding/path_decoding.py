...
def visualize_maximizing_img(methods, dir):
  ...
  plt.savefig(f'{SRC_DIR}/tools/DEEPDOMAIN/pathway_grad/path_decoding/maximizing_img/maximizing_img.png')
  
methods = ['Original Net', 'Active Subnet', 'NeuronIntGrad', 'NeuronMCT', 'DGR(init=1)', 'DGR(init=r)', 'GreedyPruning']
visualize_maximizing_img(methods, f'{SRC_DIR}/tools/DEEPDOMAIN/pathway_grad/path_decoding/maximizing_img/')
...
def visualize_top_neuron(dir, idxs, methods):
  ...
  plt.tight_layout()
  plt.subplots_adjust(wspace=0.05, hspace=0.01)
  plt.savefig(f'{SRC_DIR}/tools/DEEPDOMAIN/pathway_grad/path_decoding/top_neuron_vis/top_neuron_vis.png')
