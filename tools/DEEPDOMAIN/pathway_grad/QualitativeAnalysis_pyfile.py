...
dir = f'{SRC_DIR}/tools/DEEPDOMAIN/pathway_grad/path_decoding/maximizing_img/'
...
def visualize(model, dataloader, images, classes, gradcam_layer, model_sparsity_threshold):
    ...
    plt.savefig(f'{SRC_DIR}/tools/DEEPDOMAIN/pathway_grad/path_decoding/maximizing_img/appendix_attribution_'+str(1)+'.png', dpi=200) #'./fig'+str(id)+'.png', dpi=200)
    id += 1
...
visualize(model, dataloader, None, None, vgg_gradcam_layer, model_sparsity_threshold)
