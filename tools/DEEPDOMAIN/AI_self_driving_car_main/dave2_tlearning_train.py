...
udacity_dataset = UD.UdacityDataset(csv_file=f'{SRC_DIR}/dataset/deepdomain/transfer/train/labels.csv',
                             root_dir=f'{SRC_DIR}/dataset/deepdomain/transfer/center/train/',
...
training_set = UD.UdacityDataset(csv_file=f'{SRC_DIR}/dataset/deepdomain/transfer/train/labels.csv',
                             root_dir=f'{SRC_DIR}/dataset/deepdomain/transfer/train/center/',
...
validation_set = UD.UdacityDataset(csv_file=f'{SRC_DIR}/dataset/deepdomain/transfer/train/labels.csv',
                             root_dir=f'{SRC_DIR}/dataset/deepdomain/transfer/train/center/',
                            transform=transforms.Compose([
                                transforms.ToTensor(),
                                transforms.Normalize(0.5, 0.5)]),
...
write_pickle(training_loader, f"{SRC_DIR}/tools/DEEPDOMAIN/AI_self_driving_car_main/saved_models/transfer/training_loader.obj")
write_pickle(validation_loader, f"{SRC_DIR}/tools/DEEPDOMAIN/AI_self_driving_car_main/saved_models/transfer/validation_loader.obj")
