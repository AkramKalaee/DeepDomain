...
def visualize(model, dataloader, images, classes, gradcam_layer, model_sparsity_threshold):
    ...
    plt.savefig(f'{SRC_DIR}/pathway_grad/path_decoding/maximizing_img/appendix_attribution_'+str(1)+'.png', dpi=200,  bbox_inches='tight', pad_inches=0) #'./fig'+str(id)+'.png', dpi=200)
    id += 1
