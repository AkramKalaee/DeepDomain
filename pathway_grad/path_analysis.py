...
from models.dave import dave_orig_keras, dave_orig
import os
...
dir = f'{SRC_DIR}/dataset/train/'
weights_path = f"{SRC_DIR}/models/dave_orig/dave_orig.pt"
...
def analyze_paths(model, dataloader, images, classes, model_sparsity_threshold):
    global id
    base_dir = f'{SRC_DIR}/tools/DEEPDOMAIN/results/dave_orig/paths_logs_'+str(model_sparsity_threshold)+'/'
    print(base_dir)
...
analyze_paths(model, dataloader, None, None, model_sparsity_threshold)
