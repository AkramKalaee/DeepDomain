...
def visualize_maximizing_img(methods, dir):
  ...
  fig = plt.figure(figsize=(n + 1, 1), dpi=100)  # Adjust figsize and dpi as needed
  ...
  plt.savefig(f'{SRC_DIR}/pathway_grad/path_decoding/maximizing_img/maximizing_img.png',
             dpi=200)


methods = ['Original Net', 'Active Subnet', 'NeuronIntGrad', 'NeuronMCT', 'DGR(init=1)', 'DGR(init=r)', 'GreedyPruning']
visualize_maximizing_img(methods, f'{SRC_DIR}/pathway_grad/path_decoding/maximizing_img/')
